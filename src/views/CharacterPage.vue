...
<template>
  <div class="w-[1280px] mx-auto grid h-auto absolute mt-36 left-0 right-0">
    <div class="mx-[150px] grid content-center text-center grid-cols-2">
      <div class="overflow-hidden grid content-center">
        <img
          ...
          class="h-[500px] w-auto object-cover"
      ...
      <div class="bg-bgColor rounded-xl border p-12 text-white border-white">
        ...
        <div>
          <img v-if="characterData.rarity == 5" src="/5star.png" class="h-4 mt-3" />
        ...
        <div class="grid grid-cols-3 divide-y">
          ...
          <div class="text-left font-semibold text-md py-4 col-span-1">Vision</div>
          <div class="text-left text-md py-4 col-start-2 col-span-2">
            {{ characterData.vision }}
          </div>
          <div class="text-left font-semibold text-md py-4 col-span-1">Birthday</div>
          <div class="text-left text-md py-4 col-start-2 col-span-2">
            {{ characterData.birthday }}
          </div>
          <div class="text-left font-semibold text-md py-4 col-span-1">Location</div>
          <div class="text-left text-md py-4 col-start-2 col-span-2">
            {{ characterData.location }}
          </div>
          <div class="text-left font-semibold text-md py-4 col-span-1">Title</div>
          <div class="text-left text-md py-4 col-start-2 col-span-2">
            {{ characterData.title }}
          </div>
          <div class="text-left font-semibold text-md py-4 col-span-1">Constellation</div>
          <div class="text-left text-md py-4 col-start-2 col-span-2">
    ...
    <!-- title-->
    <div class="mr-24 ml-24 grid content-center text-center grid-cols-8 mt-16 mb-8">
    ...
    <!-- title-->
    <div class="mx-[150px] grid content-center text-center grid-cols-3 mb-36 gap-4">
      <div class="bg-bgColor rounded-xl border p-8 text-white border-white mb-8 divide-y">
        <div class="flex flex-row">
          <div>
            <img :src="characterData.normalAttack.icon" class="h-auto w-16" />
          </div>
          <div class="text-left ml-4 grid place-content-center text-md font-semibold">
      ...
      <div class="bg-bgColor rounded-xl border p-8 text-white border-white mb-8 divide-y">
        ...
        <div class="pt-4 mt-4 text-left">
          <span class="font-semibold">Cooldown</span> : {{ characterData.elementalSkill.cooldown }}
        </div>
        <div class="pt-4 mt-4 text-left">
      ...
      <div class="bg-bgColor rounded-xl border p-8 text-white border-white mb-8 divide-y">
        ...
        <div class="pt-4 mt-4 text-left">
          <span class="font-semibold">Cooldown</span> : {{ characterData.elementalBurst.cooldown }}
        </div>
        <div class="pt-4 mt-4 text-left">
          <span class="font-semibold">Max Charge</span> :
